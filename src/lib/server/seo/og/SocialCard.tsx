    ...
    <div tw="flex flex-col w-[1200px] h-[630px] bg-slate-900 text-white font-sans">
      ...
      <div tw="flex flex-col justify-between flex-1 p-16">
        ...
        <div tw="flex flex-col gap-5 items-center text-center justify-center flex-1">
          <div tw="text-[64px] font-extrabold leading-tight tracking-tight">{title}</div>
        ...
        {(author || date) && (
          <div tw="flex items-center gap-6 text-[22px]">
            {author && (
              <div tw="flex items-center gap-2.5 font-semibold text-green-400">
                {PersonIcon}
                <span>{author}</span>
              </div>
            )}
            ...
            {date && (
              <div tw="flex items-center gap-2.5 text-orange-400">
                {CalendarIcon}
                <span>{date}</span>
              </div>
            )}
